...
def relabel_tree(pred_form_file: Path, true_form_file: Path, 
                 out_form_file: Path, add_binned: bool, add_raw):
    """relabel_tree.
...
def main():
    ...
    true_form_files = [true_form_folder / i.name.replace("pred_", "")
                      for i in pred_form_files]
